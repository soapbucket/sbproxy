...
Skip the semantic cache for certain requests:
...
These headers let you build dashboards, set budget alerts, and charge back to internal teams without modifying your application code.
