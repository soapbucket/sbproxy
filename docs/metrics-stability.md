...
| `sbproxy_ai_compression_mesh_events_total` | Counter | `stable` | `beta` | `event` | Mesh compression convergence, conflict, and tombstone events. |
| `sbproxy_ai_compression_ratio` | Histogram | `stable` | `beta` | `tenant_id`, `api_key_id`, `lever` | Final-to-initial token ratio for applied AI context compression levers. |
...
| `sbproxy_ai_compression_request_tokens_saved` | Histogram | `stable` | `beta` | `tenant_id`, `api_key_id`, `outcome`, `backend` | Initial-to-final target-model tokens saved once per compression request. |
...
| `sbproxy_ai_compression_tokens_saved_total` | Counter | `stable` | `beta` | `tenant_id`, `api_key_id`, `lever` | Target-model tokens removed by applied AI context compression levers. |
| `sbproxy_ai_compression_tokens_total` | Counter | `stable` | `beta` | `tenant_id`, `api_key_id`, `lever`, `direction` | Target-model tokens before and after an applied AI context compression lever. |
