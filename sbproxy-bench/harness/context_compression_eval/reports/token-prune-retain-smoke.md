...
- Profile: `token-prune-retain-recorded-smoke-v1`
- Report schema: `4`
...
1. `{"type":"token_prune","min_tokens":32,"endpoint":"recorded://token-prune-v1","model":"llmlingua-2-recorded-smoke-v1","timeout_ms":25,"max_chunks":8,"target":{"mode":"retain_ratio","retain_percent":45}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---|
| overall | 2 | 646 | 350 | 296 | 45.82% | 1.000 | 1.000 | +0.000 | pass | not measured | build |
| token_prune_smoke | 2 | 646 | 350 | 296 | 45.82% | 1.000 | 1.000 | +0.000 | pass | not measured | build |
...
|---|---|---|---|---:|---:|---:|---:|---:|---|---|---|
| token_prune_depot_lookup | token_prune_smoke | gpt-4 | evidence_retention | 148 | 45.26% | 1.000 | 1.000 | +0.000 | pass | applied | - |
| token_prune_route_lookup | token_prune_smoke | gpt-4 | evidence_retention | 148 | 46.39% | 1.000 | 1.000 | +0.000 | pass | applied | - |

## Ordered lever results

| Case | Order | Lever | Before | After | Saved | Outcome | Reason |
|---|---:|---|---:|---:|---:|---|---|
| token_prune_depot_lookup | 1 | token_prune | 327 | 179 | 148 | applied | - |
| token_prune_route_lookup | 1 | token_prune | 319 | 171 | 148 | applied | - |
