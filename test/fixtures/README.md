...
|---|---|---|
| `wave2/registry/keys.json` | `` (G2.1) | Ed25519 seed for the agent-registry feed signing key. Used by Q2.3 and Q2.11. |
| `wave2/kya/` | (Wave 5 placeholder) | Reserved for KYA-token seeds; populated when Wave 5 lands. |
| `wave1/bot_auth_directory/keys.json` | `` (A1.3) | Ed25519 seed for the JWKS directory self-signature. Used by Q1.4 and Q2.13. |
