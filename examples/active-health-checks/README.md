...
# Block one target (drop test.sbproxy.dev/status/503 from /etc/hosts to simulate failure).
...
#   active_health_check target=https://test.sbproxy.dev status=ok consecutive_ok=2
#   active_health_check target=https://test.sbproxy.dev/status/503 status=fail consecutive_fail=1
#   active_health_check target=https://test.sbproxy.dev/status/503 status=fail consecutive_fail=2
#   active_health_check target=https://test.sbproxy.dev/status/503 status=fail consecutive_fail=3 -> unhealthy
#
# After unhealthy mark, every request lands on test.sbproxy.dev until the probe
