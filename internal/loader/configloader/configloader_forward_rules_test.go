...
func TestForwardRules_PathPrefixMatching(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, tt.hostname, 0, mgr, nil)
			if err != nil {
...
func TestForwardRules_MissingTargetConfig(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "forward-rules-complex.test", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
...
func TestForwardRules_ParentApplyEnabledByDefault(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "gateway.test", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
...
func TestForwardRules_CachedConfig(t *testing.T) {
	...
	cfg1, err := defaultLoader.getConfigByHostname(context.Background(), req1, "forward-rules-complex.test", 0, mgr, nil)
	if err != nil {
		t.Fatalf("First request: defaultLoader.getConfigByHostname() error = %v", err)
	}
	...
	cfg2, err := defaultLoader.getConfigByHostname(context.Background(), req2, "forward-rules-complex.test", 0, mgr, nil)
	if err != nil {
		t.Fatalf("Second request: defaultLoader.getConfigByHostname() error = %v", err)
	}
