...
func resetCache() {
	defaultLoader.cache, _ = objectcache.NewObjectCache(10*time.Minute, 1*time.Minute, 1000, 100*1024*1024)
	defaultLoader.failsafeSnapshots.resetForTests()
}
...
func TestGetConfigByHostname_CacheHit(t *testing.T) {
	...
	cfg1, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
	if cfg1.ID != "config-1" {
	...
	cfg2, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
	if cfg2.ID != "config-1" {
...
func TestGetConfigByHostname_MaxForwardDepth(t *testing.T) {
	...
	_, err := defaultLoader.getConfigByHostname(context.Background(), req, "host1.com", 0, mgr, nil)
...
func TestGetConfigByHostname_ForwardRules(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "host1.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
...
func TestGetConfigByHostname_HostnameFallback(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com:8080", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
...
func TestGetConfigByHostname_NullConfig(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "notfound.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
...
func TestGetConfigByHostname_StorageError(t *testing.T) {
	...
	_, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com", 0, mgr, nil)
	if err == nil {
...
func TestGetConfigByHostname_DefaultMaxForwardDepth(t *testing.T) {
	...
	_, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com", DefaultMaxForwardDepth+1, mgr, nil)
	if !errors.Is(err, ErrMaxForwardDepthReached) {
...
func TestGetConfigByHostname_CachedForwardRule(t *testing.T) {
	...
	cfg1, err := defaultLoader.getConfigByHostname(context.Background(), req, "host1.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
	if cfg1.ID != "config-2" {
	...
	cfg2, err := defaultLoader.getConfigByHostname(context.Background(), req, "host1.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
	if cfg2.ID != "config-2" {
...
func TestMustMatchRules_NoRules_LoadsNormally(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "example.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("defaultLoader.getConfigByHostname() error = %v", err)
	}
	if cfg.ID != "config-1" {
...
func TestWildcardFallback_ExactMatchTakesPriority(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "api.example.com", 0, mgr, nil)
	if err != nil {
...
func TestWildcardFallback_MatchesWildcard(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "foo.example.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestWildcardFallback_NoWildcard_ReturnsNullConfig(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "unknown.example.com", 0, mgr, nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	if cfg.ID != "null-config" {
...
func TestWildcardFallback_PortStrippedBeforeWildcard(t *testing.T) {
	...
	cfg, err := defaultLoader.getConfigByHostname(context.Background(), req, "api.example.com:8080", 0, mgr, nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	if cfg.ID != "wildcard-config" {
...
func TestHostFilter_Rejects(t *testing.T) {
	...
	oldFilter := defaultLoader.hostFilter
	defaultLoader.hostFilter = &mockHostFilter{allow: false}
	defer func() { defaultLoader.hostFilter = oldFilter }()
...
func TestHostFilter_Passes(t *testing.T) {
	...
	oldFilter := defaultLoader.hostFilter
	defaultLoader.hostFilter = &mockHostFilter{allow: true}
	defer func() { defaultLoader.hostFilter = oldFilter }()
...
func TestHostFilter_NormalizesHostPortBeforeCheck(t *testing.T) {
	...
	oldFilter := defaultLoader.hostFilter
	defaultLoader.hostFilter = filter
	defer func() { defaultLoader.hostFilter = oldFilter }()
