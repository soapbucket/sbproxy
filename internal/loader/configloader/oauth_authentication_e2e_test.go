...
func TestOAuth_GoogleProvider_E2E(t *testing.T) {
	...
	// Extract the auth endpoint from mock URL
	authURL := strings.TrimPrefix(googleMock.URL, "http://")
...
// Helper: Create HMAC signature for state validation
func createStateSignature(state, secret string) string {
