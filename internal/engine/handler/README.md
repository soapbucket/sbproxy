...
import (
    "net/http"
    "time"
    "github.com/soapbucket/proxy/internal/handler"
)
...
# Specific benchmarks
go test -bench=BenchmarkProxy -benchmem ./internal/handler/
go test -bench=BenchmarkCachedResponse -benchmem ./internal/handler/
```
...
- [Cacher Package](../cacher/README.md) - Caching backends
- [Origin Package](../origin/README.md) - Origin management
