...
// This is a proxy-local mirror of config.TrustMode to avoid importing internal/config.
type TrustMode string

const (
	// TrustAll trusts all incoming proxy headers.
	TrustAll TrustMode = "trust_all"
	// TrustTrustedProxies only trusts headers from configured CIDRs.
	TrustTrustedProxies TrustMode = "trust_trusted_proxies"
	// TrustNone ignores all incoming proxy headers.
