...
// This is a proxy-local mirror of config.TrailerType to avoid importing internal/config.
type TrailerType string

const (
	// TrailerChecksum generates a checksum trailer.
	TrailerChecksum TrailerType = "checksum"
	// TrailerTiming generates a timing trailer.
	TrailerTiming TrailerType = "timing"
	// TrailerCustom generates a custom (CEL expression) trailer.
	TrailerCustom TrailerType = "custom"
)

// TrailerGenerator defines a generated trailer header.
// This is a proxy-local mirror of config.TrailerGenerator to avoid importing internal/config.
