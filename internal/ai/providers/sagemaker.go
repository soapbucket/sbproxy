...
//
// The SageMaker provider requires the AWS SDK and is not available in this build.
...
var errSageMakerNotAvailable = fmt.Errorf("sagemaker: provider not available in this build (AWS SDK not compiled in)")
