...
//
// The Bedrock provider requires the AWS SDK and is not available in this build.
...
var errBedrockNotAvailable = fmt.Errorf("bedrock: provider not available in this build (AWS SDK not compiled in)")
