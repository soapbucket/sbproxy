...
// These are no-ops by default. An enterprise metrics package can replace them
// at init time to emit to Prometheus or another backend without pulling in
// heavy dependencies in the core package.
var (
