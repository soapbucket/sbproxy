...
// Feature flags are populated via reqctx.RequestData.FeatureFlags at request time.
func SetFeatureFlagGetter(_ func(ctx context.Context, workspaceID string) map[string]any) {
	// no-op: feature flags are populated via reqctx.RequestData.FeatureFlags
}
