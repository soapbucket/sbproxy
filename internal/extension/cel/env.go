...
// toStringKeyMap converts the result of ConvertToNative to map[string]interface{}.
// cel-go 0.28+ may return map[interface{}]interface{} instead of map[string]interface{}.
func toStringKeyMap(nativeMap interface{}) (map[string]interface{}, error) {
