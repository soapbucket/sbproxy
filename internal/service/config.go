...
func setViperDefaults() {
	...
	viper.SetDefault("maxmind.driver", globalConfig.MaxmindSettings.Driver)
	viper.SetDefault("maxmind.params", globalConfig.MaxmindSettings.Params)
	viper.SetDefault("maxmind.enable_metrics", globalConfig.MaxmindSettings.EnableMetrics)
	viper.SetDefault("maxmind.enable_tracing", globalConfig.MaxmindSettings.EnableTracing)
