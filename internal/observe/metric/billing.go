...
var (
	...
	BillingRequestsTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
	...
	BillingBytesInTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
	...
	BillingBytesOutTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
	...
	BillingBytesBackendTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
	...
	BillingErrorsTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
	...
	BillingTokensTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
	...
	BillingCacheBytesTotal = mustRegisterCounterVec(prometheus.NewCounterVec(
		prometheus.CounterOpts{
