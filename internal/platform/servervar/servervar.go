// Package servervar manages server-level variable singletons populated at startup.
// These include built-in values (version, hostname, etc.) and operator-defined custom
// variables from the sb.yml "var" section.
package servervar
