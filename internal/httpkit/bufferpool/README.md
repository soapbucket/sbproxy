...
```go
import "github.com/soapbucket/sbproxy/internal/httpkit/bufferpool"
...
1. Run tests: `go test ./internal/httpkit/bufferpool/...`
2. Run benchmarks: `go test -bench=. -benchmem ./internal/httpkit/bufferpool/`
