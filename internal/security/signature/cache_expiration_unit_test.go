...
func (m *mockManagerWithCacheForTest) GetLocation(*http.Request) (*maxmind.Result, error) {
	return nil, nil
}

func (m *mockManagerWithCacheForTest) GetUserAgent(*http.Request) (*uaparser.Result, error) {
	return nil, nil
}
