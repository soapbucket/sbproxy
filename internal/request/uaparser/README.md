...
```bash
go test ./internal/request/uaparser/...
```

## Dependencies

- `github.com/ua-parser/uap-go/uaparser`: User agent parsing library
- `github.com/soapbucket/sbproxy/internal/cache/store`: Caching library
- `github.com/soapbucket/sbproxy/internal/observe/metric`: Metrics library
