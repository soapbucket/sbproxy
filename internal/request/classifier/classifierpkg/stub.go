// Package classifierpkg is a local stub replacing the enterprise
// prompt-classifier/client/go dependency.  It provides the same types and
// constructors so that the rest of the codebase compiles, but every
// operation is a no-op or returns an error.
