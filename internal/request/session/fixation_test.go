...
func (m *fixationMockManager) GetLocation(*http.Request) (*maxmind.Result, error) { return nil, nil }
func (m *fixationMockManager) GetUserAgent(*http.Request) (*uaparser.Result, error) { return nil, nil }
