...
pub const METRICS: &[MetricCapability] = &[
    ...
    MetricCapability {
        name: "sbproxy_key_audit_write_failures_total",
        kind: MetricKind::Counter,
        writer: Writer::Recorder("record_key_audit_write_outcome"),
        support: SupportLevel::Stable,
        compat: CompatTier::Beta,
        registry: Registry::Default,
        labels: &["channel"],
        description: "Key-management audit emissions that did not reach a sink they were promised, by audit channel; healthy systems read 0.",
        dead_reason: None,
    },
    MetricCapability {
