...
pub const METRICS: &[MetricCapability] = &[
    ...
    MetricCapability {
        ...
        registry: Registry::Default,
        labels: &["outcome"],
        description: "OpenID Federation entity-statement JWS verification outcomes, covering both self-signed entity configurations and subordinate statements.",
        dead_reason: None,
    },
    MetricCapability {
        ...
        registry: Registry::Default,
        labels: &["outcome"],
        description: "OpenID Federation trust-chain resolution outcomes, one per resolver call.",
        dead_reason: None,
    },
    MetricCapability {
        ...
        registry: Registry::Default,
        labels: &["outcome"],
        description: "OpenID Federation trust-mark JWS verification outcomes. Offline signature check only; live revocation status is a separate call this crate does not make.",
        dead_reason: None,
    },
    MetricCapability {
